...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo 'bootstrap-1.4.0.min.css?v='.$plugin_version; ?>"/>
	<script type="text/javascript" src="<?php echo '../../../../wp-includes/js/tinymce/tiny_mce_popup.js?v='.$plugin_version; ?>"></script>
	<style type="text/css">
